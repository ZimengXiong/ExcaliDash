...
const validateHttpUrl = (value: string | null, name: string): string | null => {
...
const resolveChatGptConfig = (): AiChatGptConfig => {
  ...
  return {
    ...
    codexBaseUrl: validateHttpUrl(
      readOptionalString("AI_CHATGPT_CODEX_BASE_URL") ??
        "https://chatgpt.com/backend-api/codex",
      "AI_CHATGPT_CODEX_BASE_URL",
    )!,
...
export const resolveAiConfig = (): AiConfig => ({
  ...
  baseUrl: validateHttpUrl(readOptionalString("AI_BASE_URL"), "AI_BASE_URL"),
