...
const MAX_IMPORT_ARCHIVE_ENTRIES = 1500;
const MAX_IMPORT_COLLECTIONS = 1000;
const MAX_IMPORT_DRAWINGS = 1000;
const MAX_IMPORT_MANIFEST_BYTES = 2 * 1024 * 1024;
const MAX_IMPORT_DRAWING_BYTES = 5 * 1024 * 1024;
const MAX_IMPORT_TOTAL_EXTRACTED_BYTES = 50 * 1024 * 1024;
...
registerDashboardRoutes(app, {
  ...
  config,
  logAuditEvent,
  internDrawingFiles: (files, userId, drawingId, stagingJournal) =>
    internDrawingFilesWithPrisma(
      files,
      userId,
      drawingId,
      prisma,
