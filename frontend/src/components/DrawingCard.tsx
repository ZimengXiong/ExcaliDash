      ...
      >
        ...
        >
          ...
          {drawing.engine === "tldraw" && (
            <span
              className="absolute left-2.5 top-2.5 z-20 rounded-full border border-slate-300 bg-white/90 px-2 py-0.5 text-[10px] font-bold text-slate-600 shadow-sm dark:border-neutral-600 dark:bg-neutral-900/90 dark:text-neutral-300"
              title="tldraw canvas"
            >
              tldraw
            </span>
