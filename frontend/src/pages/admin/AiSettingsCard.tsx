    ...
    <section className="mb-6">
      ...
      <SettingsCard>
        <SettingsRow
          ...
          description="Hide every AI control and block AI APIs without deleting saved providers."
        >
          <PlayfulSwitch
            checked={enabled}
      ...
      {!enabled ? (
        <p className="mt-3 px-1 text-sm font-medium text-slate-500 dark:text-neutral-400">
          AI features are disabled. Turn them back on to manage the saved
          provider registry.
        </p>
      ) : (
        <>
            ...
            <div className="flex items-center gap-3">
              {status ? (
                <span className="text-sm font-medium text-slate-500 dark:text-neutral-400">
                  {
                    status.providers.filter((profile) => profile.available)
                      .length
                  }{" "}
                  available
                </span>
