...
const STR = {
  ...
  intro:
    "Connect your ChatGPT Plus or Pro account. Requests use that account instead of a server API key. ExcaliDash encrypts the connection tokens on the server.",
  reconnect:
    "Your ChatGPT connection expired. Reconnect to keep using the assistant.",
  connect: "Connect ChatGPT",
  opening: "Opening ChatGPT…",
  step2:
    "After you approve access, the browser opens a localhost URL that might not load. Copy the full URL from the address bar, and paste it below.",
